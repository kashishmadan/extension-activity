...
print("YOUR SSH SERVER IS UP AND RUNNING\n")
...
def encode_to_UTF8(data):
        try:
            ...
            logging.info("Could not encode data to UTF-8 -- %s" % e)
            return False
...
class WebSocket(object):
    ...
    def feed(self, data):
        ...
        if not self.handshaken:
            ...
            print("HANDSHAKE IS ALREADY COMPLETE")
            ...
            if self.state == 1:
                ...
                if validation == 1:
                    ...
                    print("THE USER \""+cmd+"\" IS TRYING TO LOGIN\n")
                else:
                    self.state = 1
                    self.sendMessage("Invalid User! <br> Enter Username : ")
                    print("THIS USER \""+cmd+"\" DOES NOT EXIST\n")
            ...
            # Password has to be entered
                ...
                if password_validation == 1:
                    ...
                    print(cmd+" HAS LOGGED IN")
                    self.state = 0
                else:
                    self.sendMessage("Wrong Password!")
                    self.sendMessage("Enter Password : ")
                    print(cmd+"-WRONG PASSWORD")
                    self.state = 2
